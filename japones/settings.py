"""
Django settings for japones project.
...
SECRET_KEY = 'django-insecure-$&=v%@ull)-77nle1z3*b&_-9c_a6%x7g=_+2@+wd5ra!a=8)#'
...
INSTALLED_APPS = [
    'corsheaders', # para los servidores y dominios
    'rest_framework', # para las APIs
    'coreapi',
    'es_a_jp', # nombre de "startapp" ejm {appname}
...
WSGI_APPLICATION = 'japones.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'japones', # nombre de la base de datos
